...
sub_arr[11][1105]="朝阳区";
sub_arr[11][1106]="丰台区";
sub_arr[11][1107]="石景山区";
sub_arr[11][1108]="海淀区";
sub_arr[11][1109]="门头沟区";
sub_arr[11][1111]="房山区";
sub_arr[11][1112]="通州区";
sub_arr[11][1113]="顺义区";
sub_arr[11][1114]="昌平区";
...
sub_arr[4602]=[];
sub_arr[4602][0]="请选择";
sub_arr[4602][4602]="三亚市";

l_arr[4603]="五指山市";
sub_arr[4603]=[];
sub_arr[4603][0]="请选择";
sub_arr[4603][4603]="五指山市";

l_arr[4604]="琼海市";
sub_arr[4604]=[];
sub_arr[4604][0]="请选择";
sub_arr[4604][4604]="琼海市";

l_arr[4605]="儋州市";
sub_arr[4605]=[];
sub_arr[4605][0]="请选择";
sub_arr[4605][4605]="儋州市";

l_arr[4607]="文昌市";
sub_arr[4607]=[];
sub_arr[4607][0]="请选择";
sub_arr[4607][4607]="文昌市";

l_arr[4608]="万宁市";
sub_arr[4608]=[];
sub_arr[4608][0]="请选择";
sub_arr[4608][4608]="万宁市";

l_arr[4609]="东方市";
sub_arr[4609]=[];
sub_arr[4609][0]="请选择";
sub_arr[4609][4609]="东方市";

l_arr[4623]="定安县";
sub_arr[4623]=[];
sub_arr[4623][0]="请选择";
sub_arr[4623][4623]="定安县";

l_arr[4624]="屯昌县";
sub_arr[4624]=[];
sub_arr[4624][0]="请选择";
sub_arr[4624][4624]="屯昌县";

l_arr[4625]="澄迈县";
sub_arr[4625]=[];
sub_arr[4625][0]="请选择";
sub_arr[4625][4625]="澄迈县";

l_arr[4626]="临高县";
sub_arr[4626]=[];
sub_arr[4626][0]="请选择";
sub_arr[4626][4626]="临高县";

l_arr[4627]="白沙";
sub_arr[4627]=[];
sub_arr[4627][0]="请选择";
sub_arr[4627][4627]="白沙";

l_arr[4628]="昌江";
sub_arr[4628]=[];
sub_arr[4628][0]="请选择";
sub_arr[4628][4628]="昌江";

l_arr[4629]="乐东";
sub_arr[4629]=[];
sub_arr[4629][0]="请选择";
sub_arr[4629][4629]="乐东";

l_arr[4630]="陵水";
sub_arr[4630]=[];
sub_arr[4630][0]="请选择";
sub_arr[4630][4630]="陵水";

l_arr[4631]="保亭";
sub_arr[4631]=[];
sub_arr[4631][0]="请选择";
sub_arr[4631][4631]="保亭";

l_arr[4632]="琼中";
sub_arr[4632]=[];
sub_arr[4632][0]="请选择";
sub_arr[4632][4632]="琼中";

l_arr[4690]="洋浦经济开发区";
sub_arr[4690]=[];
sub_arr[4690][0]="请选择";
sub_arr[4690][4690]="洋浦经济开发区";
...
sub_arr[50][5002]="涪陵区";
sub_arr[50][5003]="渝中区";
sub_arr[50][5004]="大渡口区";
sub_arr[50][5005]="江北区";
sub_arr[50][5006]="沙坪坝区";
sub_arr[50][5007]="九龙坡区";
sub_arr[50][5008]="南岸区";
sub_arr[50][5009]="北碚区";
sub_arr[50][5010]="万盛区";
sub_arr[50][5011]="双桥区";
...
sub_arr[50][5037]="巫山县";
sub_arr[50][5038]="巫溪县";
sub_arr[50][5040]="石柱土家族自治县";
sub_arr[50][5041]="秀山土家族苗族自治县";
sub_arr[50][5042]="酉阳土家族苗族自治县";
sub_arr[50][5043]="彭水苗族土家族自治县";
sub_arr[50][5083]="永川区";
sub_arr[50][5084]="北部新区";
...
sub_arr[7101]=[];
sub_arr[7101][0]="请选择";
sub_arr[7101][7101]="台北市";

l_arr[7102]="高雄市";
sub_arr[7102]=[];
sub_arr[7102][0]="请选择";
sub_arr[7102][7102]="高雄市";

l_arr[7103]="基隆市";
sub_arr[7103]=[];
sub_arr[7103][0]="请选择";
sub_arr[7103][7103]="基隆市";

l_arr[7104]="台中市";
sub_arr[7104]=[];
sub_arr[7104][0]="请选择";
sub_arr[7104][7104]="台中市";

l_arr[7105]="台南市";
sub_arr[7105]=[];
sub_arr[7105][0]="请选择";
sub_arr[7105][7105]="台南市";

l_arr[7106]="新竹市";
sub_arr[7106]=[];
sub_arr[7106][0]="请选择";
sub_arr[7106][7106]="新竹市";

l_arr[7107]="嘉义市";
sub_arr[7107]=[];
sub_arr[7107][0]="请选择";
sub_arr[7107][7107]="嘉义市";

l_arr[7108]="台北县";
sub_arr[7108]=[];
sub_arr[7108][0]="请选择";
sub_arr[7108][7108]="台北县";

l_arr[7109]="宜兰县";
sub_arr[7109]=[];
sub_arr[7109][0]="请选择";
sub_arr[7109][7109]="宜兰县";

l_arr[7110]="新竹县";
sub_arr[7110]=[];
sub_arr[7110][0]="请选择";
sub_arr[7110][7110]="新竹县";

l_arr[7111]="桃园县";
sub_arr[7111]=[];
sub_arr[7111][0]="请选择";
sub_arr[7111][7111]="桃园县";

l_arr[7112]="苗栗县";
sub_arr[7112]=[];
sub_arr[7112][0]="请选择";
sub_arr[7112][7112]="苗栗县";

l_arr[7113]="台中县";
sub_arr[7113]=[];
sub_arr[7113][0]="请选择";
sub_arr[7113][7113]="台中县";

l_arr[7114]="彰化县";
sub_arr[7114]=[];
sub_arr[7114][0]="请选择";
sub_arr[7114][7114]="彰化县";

l_arr[7115]="南投县";
sub_arr[7115]=[];
sub_arr[7115][0]="请选择";
sub_arr[7115][7115]="南投县";

l_arr[7116]="嘉义县";
sub_arr[7116]=[];
sub_arr[7116][0]="请选择";
sub_arr[7116][7116]="嘉义县";

l_arr[7117]="云林县";
sub_arr[7117]=[];
sub_arr[7117][0]="请选择";
sub_arr[7117][7117]="云林县";

l_arr[7118]="台南县";
sub_arr[7118]=[];
sub_arr[7118][0]="请选择";
sub_arr[7118][7118]="台南县";

l_arr[7119]="高雄县";
sub_arr[7119]=[];
sub_arr[7119][0]="请选择";
sub_arr[7119][7119]="高雄县";

l_arr[7120]="屏东县";
sub_arr[7120]=[];
sub_arr[7120][0]="请选择";
sub_arr[7120][7120]="屏东县";

l_arr[7121]="台东县";
sub_arr[7121]=[];
sub_arr[7121][0]="请选择";
sub_arr[7121][7121]="台东县";

l_arr[7122]="花莲县";
sub_arr[7122]=[];
sub_arr[7122][0]="请选择";
sub_arr[7122][7122]="花莲县";

l_arr[7123]="澎湖县";
sub_arr[7123]=[];
sub_arr[7123][0]="请选择";
sub_arr[7123][7123]="澎湖县";
...
sub_arr[81][8101]="中西区";
sub_arr[81][8102]="东区";
sub_arr[81][8103]="九龙城区";
sub_arr[81][8104]="观塘区";
sub_arr[81][8105]="南区";
sub_arr[81][8106]="深水区";
sub_arr[81][8107]="湾仔区";
sub_arr[81][8108]="黄大仙区";
sub_arr[81][8109]="油尖旺区";
sub_arr[81][8110]="离岛区";
sub_arr[81][8111]="葵青区";
sub_arr[81][8112]="北区";
sub_arr[81][8113]="西贡区";
...
sub_arr[82]=[];
sub_arr[82][0]="请选择";
sub_arr[82][8201]="花地玛堂区";
sub_arr[82][8202]="圣安多尼堂区";
sub_arr[82][8203]="大堂区";
sub_arr[82][8204]="望德堂区";
sub_arr[82][8205]="风顺堂区";
sub_arr[82][8206]="嘉模堂区";
sub_arr[82][8207]="圣方济各堂区";