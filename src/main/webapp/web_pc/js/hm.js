(function () {
    var h = {}, mt = {}, c = {
        id: "ac8fb11c31cd3cf585523fd58e170e95",
        dm: ["fadu.lvshi.baidu.com", "duxiaofa.baidu.com"],
    ...
    var t = void 0, u = !0, w = null, x = !1;
    mt.cookie = {};
    mt.cookie.set = function (b, a, k) {
        var d;
        k.M && (d = new Date, d.setTime(d.getTime() + k.M));
        document.cookie = b + "=" + a + (k.domain ? "; domain=" + k.domain : "") + (k.path ? "; path=" + k.path : "") + (d ? "; expires=" + d.toGMTString() : "") + (k.mc ? "; secure" : "")
    };
    ...
    mt.cookie.Jb = function (b, a) {
        try {
            ...
            var d = "is-cookie-enabled" === mt.cookie.get(k) ? "1" : "0";
    ...
    mt.lang.I = function (b, a) {
        ...
        if (Array.prototype.indexOf) k = -1 !== b.indexOf(a); else for (var d = 0; d < b.length; d++) if (b[d] === a) {
            k = u;
            break
        }
        return k
    ...
    (function () {
        ...
        mt.f.pb = function (a) {
            ...
            try {
                ...
                for (a = 0; d && a < b.length;) {
                    ...
                    if (!("html" === m || "body" === m)) {
                        var f = 0, n = b[a].match(/\[(\d+)\]/i), e = [];
                        if (n) f = n[1] - 1, m =
                            m.split("[")[0]; else if (1 !== d.childNodes.length) {
                            for (var p = 0, v = 0, g = d.childNodes.length; v < g; v++) {
                                var l = d.childNodes[v];
                                1 === l.nodeType && l.nodeName.toLowerCase() === m && p++;
                                if (1 < p) return w
                            }
                            if (1 !== p) return w
                        }
                        for (p = 0; p < d.childNodes.length; p++) 1 === d.childNodes[p].nodeType && d.childNodes[p].nodeName.toLowerCase() === m && e.push(d.childNodes[p]);
                        if (!e[f]) return w;
                        d = e[f]
                    }
                    a++
        ...
        mt.f.ia = function (a, b) {
            ...
            if (!a) return f;
            for (; a.parentNode != w;) {
                for (var e = 0, m = 0, n = a.parentNode.childNodes.length,
                         p = 0; p < n; p++) {
                    var v = a.parentNode.childNodes[p];
                    if (v.nodeName === a.nodeName && (e++, v === a && (m = e), 0 < m && 1 < e)) break
                }
                if ((n = "" !== a.id) && b) {
                    d.unshift("#" + encodeURIComponent(a.id));
                    break
                } else n && (n = "#" + encodeURIComponent(a.id), n = 0 < d.length ? n + ">" + d.join(">") : n, f.push(n)), d.unshift(encodeURIComponent(String(a.nodeName).toLowerCase()) + (1 < e ? "[" + m + "]" : ""));
                a = a.parentNode
            }
            f.push(d.join(">"));
            return f
        ...
        mt.f.ub = function (a) {
            var b = {top: 0, left: 0};
            if (!a) return b;
            var d = mt.f.ob(a).documentElement;
        ...
        mt.f.getAttribute = function (a, b) {
            ...
            if (!d && a.attributes && a.attributes.length) for (var f = a.attributes, e = f.length, m = 0; m < e; m++) f[m].nodeName === b && (d = f[m].nodeValue);
            return d
        };
        mt.f.U = function (a) {
            var b = "document";
        ...
        mt.f.Ba = function (a, b) {
            var d = mt.f.U(a);
            "input" === d && b && ("button" === a.type || "submit" ===
                a.type) ? d = a.value || "" : "input" === d && !b && "password" !== a.type ? d = a.value || "" : "img" === d ? (d = mt.f.getAttribute, d = d(a, "alt") || d(a, "title") || d(a, "src")) : d = "body" === d || "html" === d ? ["(hm-default-content-for-", d, ")"].join("") : mt.f.yb(a);
        ...
        (function () {
            (mt.f.Qb = function () {
                ...
                (function () {
                    if (!d) if (d = u, "complete" === document.readyState) a.W = u; else if (document.addEventListener) document.addEventListener("DOMContentLoaded", e, x), window.addEventListener("load", a, x); else if (document.attachEvent) {
            ...
            switch (typeof d) {
                ...
                default:
                    ...
                    if (d instanceof Array) {
                        var f = ["["], e = d.length, m, k, p;
                        for (k = 0; k < e; k++) switch (p = d[k], typeof p) {
                            case "undefined":
                            case "function":
                            case "unknown":
                                break;
    ...
    mt.localStorage.set = function (b, a, k) {
        var d = new Date;
        d.setTime(d.getTime() + k || 31536E6);
        try {
            window.localStorage ? (a = d.getTime() + "|" + a, window.localStorage.setItem(b, a)) : mt.localStorage.aa() && (mt.localStorage.l.expires = d.toUTCString(), mt.localStorage.l.load(document.location.hostname), mt.localStorage.l.setAttribute(b, a), mt.localStorage.l.save(document.location.hostname))
        } catch (f) {
        }
    };
    ...
    mt.Na.log = function (b, a) {
        var k = new Image, d = "mini_tangram_log_" + Math.floor(2147483648 * Math.random()).toString(36);
        window[d] = k;
        k.onload = function () {
            k.onload = w;
            k = window[d] = w;
    ...
    mt.ra.ic = function (b, a, k, d, f) {
        return '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" id="' + b + '" width="' + k + '" height="' + d + '"><param name="movie" value="' + a + '" /><param name="flashvars" value="' + (f || "") + '" /><param name="allowscriptaccess" value="always" /><embed type="application/x-shockwave-flash" name="' + b + '" width="' + k + '" height="' + d + '" src="' + a + '" flashvars="' + (f || "") + '" allowscriptaccess="always" /></object>'
    };
    mt.url = {};
            ...
            S: function (b, f) {
                return function (e) {
                    ...
                    if (m) {
                        ...
                        if (n && n === e) m.removeAttribute(b.$); else if (f && 0 < f.length && (m = a.wb(m)) && m.length) if (n = m.length, e = m[m.length - 1], 1E4 > n * e.split(">").length) for (e = 0; e < n; e++) k.Ma(b, m[e]); else k.Ma(b, e)
                    }
                }
            }, Ma: function (a, f) {
                for (var e = {}, m = String(f).split(">").length, k = 0; k < m; k++) e[f] = "", f = f.substring(0, f.lastIndexOf(">"));
                a && (b.e(a, "Object") && a.ya) && a.ya(e)
            }, Rb: function (a,
                             b) {
                return function (e) {
                    (e.target || e.srcElement).setAttribute(a.$, e.clientX + ":" + e.clientY);
    ...
    (function () {
        var b = mt.f, a = mt.o, k = mt.event, d = mt.lang, f = h.fa, e = {
            $: "HM_ce", Ra: function () {
                if (c.cetrk && c.cetrk.length) {
                    k.d(document, "click", f.S(e, c.cetrk));
                    for (var d = 0, n = c.cetrk.length; d < n; d++) {
                        var p;
                        try {
                        ...
                        var g = p.p || "";
                        -1 === g.indexOf(">") && (0 === g.indexOf("#") && (g = g.substring(1)), (g = b.Aa(g)) && k.d(g, "click", f.Rb(e, p)))
                    }
                }
            }, ya: function (b) {
                if (c.cetrk && c.cetrk.length) for (var d = 0, f = c.cetrk.length; d < f; d++) {
                    var v;
                    try {
                        v = a.parse(decodeURIComponent(String(c.cetrk[d])))
                    } catch (g) {
                        v =
                            {}
                    }
                    b.hasOwnProperty(v.p) && e.r(v)
                }
            }, r: function (a) {
                h.b.c.et = 7;
                var f = a && a.k || "", f = d.g(f), e = [];
                if (a && a.a && d.e(a.a, "Object")) for (var v in a.a) if (a.a.hasOwnProperty(v)) {
                    e.push(d.g(v));
                    var g = b.pb(a.a[v] || ""), g = g ? b.Ba(g, x) : "";
                    e.push(d.g(g))
                }
                a = "";
                e.length && (a = "*" + e.join("*"));
    ...
    (function () {
        var b = mt.f, a = mt.lang, k = mt.event, d = mt.i, f = h.s, e = h.A, m = [], n = {
            Qa: function () {
                ...
                var r;
                d.la ? (r = Math.max(document.documentElement.scrollTop, document.body.scrollTop), l = Math.max(document.documentElement.scrollLeft, document.body.scrollLeft), l = e.clientX + l, r = e.clientY + r) : (l = e.pageX, r = e.pageY);
                e = n.tb(e, g, l, r);
    ...
    (function () {
        var b = mt.lang, a = mt.f, k = mt.event, d = mt.i, f = h.s, e = h.A, m = +new Date, n = [], p = {
            S: function () {
                return function (d) {
                    if (h.b && h.b.P && c.aet && c.aet.length) {
                        var e = d.target || d.srcElement;
                        if (e) {
                            var l = h.b.xa, r = a.getAttribute(e, f.wa) != w ? u : x;
                            if (a.getAttribute(e, f.va) == w) if (r) p.ba(p.ha(e, d)); else {
                                var s = a.U(e);
                                if (b.I(l, "*") || b.I(l, s)) p.ba(p.ha(e, d)); else for (; e.parentNode != w;) {
                                    var r = e.parentNode, s = a.U(r), q = "a" === s && b.I(l, "a") ? u : x,
                                        s = "button" === s && b.I(l, "button") ? u : x,
                                        y = a.getAttribute(r, f.wa) != w ? u : x;
                                    if (a.getAttribute(r,
                                        f.va) == w && (q || s || y)) {
                                        p.ba(p.ha(r, d));
                                        break
                ...
                var l = {}, r = f.Ya;
                l.id = a.getAttribute(e, r.id) || a.getAttribute(e, "id") || "";
                l.da = a.getAttribute(e, r.da) || a.getAttribute(e, "class") || "";
                l.ua = a.getAttribute(e, r.ua) || a.Da(e);
                l.content = a.getAttribute(e, r.content) || a.Ba(e, u);
                l.sa = a.getAttribute(e, r.sa) || a.U(e);
                l.link = a.getAttribute(e, r.link) || a.getAttribute(e, "href") || "";
                l.type = g.type || "click";
                r = b.Ga(e.offsetTop) ? e.offsetTop : 0;
                "click" === g.type ? r = d.la ? g.clientY + Math.max(document.documentElement.scrollTop,
                ...
                var d = b.g;
                a = [+new Date - (h.b.C !== t ? h.b.C : m), d(a.id), d(a.da), d(a.sa), d(a.ua), d(a.link), d(a.content), a.type, a.ac].join("*");
                p.ca(a);
    ...
    (function () {
        var b = mt.event, a = mt.i, k = h.s, d = h.A, f = +new Date, e = [], m = w, n = {
            hb: function () {
                return function () {
                ...
                if (encodeURIComponent(e.join("!") + a).length > k.L || 3 < e.length) n.r(e.join("!")), e = [];
                e.push(a)
            }, r: function (b) {
                h.b.c.et = 6;
                h.b.c.vh = a.H();
                ...
                return function () {
                    e && e.length && (n.r(e.join("!")),
                        e = [])
                }
            }
        };
        mt.lang.ma() && "" !== c.aet && d.d("pv-b", function () {
    ...
    (function () {
        ...
        function a() {
            ...
            y && (b = !document[y]);
            n = "undefined" == typeof b ? u : b;
            if ((!m || !p) && n && v) s = u, l = +new Date; else if (m && p && (!n || !v)) s = x, r += +new Date - l;
            m = n;
            p = v;
            z = setTimeout(a, 100)
        }
        ...
        function k(a) {
            var l = document, b = "";
            if (a in l) b = a; else for (var d = ["webkit", "ms", "moz", "o"], q = 0; q < d.length; q++) {
                var e = d[q] + a.charAt(0).toUpperCase() + a.slice(1);
                if (e in l) {
                    b =
                        e;
                    break
        ...
        function d(l) {
            if (!("focus" == l.type || "blur" == l.type) || !(l.target && l.target != window)) v = "focus" == l.type || "focusin" == l.type ? u : x, a()
        }

        var f = mt.event, e = h.A, m = u, n = u, p = u, v = u, g = +new Date, l = g, r = 0, s = u,
    ...
    (function () {
        var b = mt.lang, a = h.s, k = h.load, d = {
            Ib: function (d) {
                if ((window._dxt === t || b.e(window._dxt, "Array")) && "undefined" !== typeof h.b) {
                    var e = h.b.T();
                    k([a.protocol, "//datax.baidu.com/x.js?si=", c.id, "&dm=", encodeURIComponent(e)].join(""), d)
                }
            }, $b: function (a) {
    ...
    (function () {
        function b(a, b, d, q) {
            if (!(a === t || b === t || q === t)) {
                ...
                a = String(a).split("!");
                for (var e, f = x, g = 0; g < a.length; g++) if (e = a[g].split("*"), String(b) === e[0]) {
                    e[1] = d;
                    e[2] = q;
                    a[g] = e.join("*");
                    f = u;
        ...
        function a(l) {
            for (var b in l) if ({}.hasOwnProperty.call(l, b)) {
                var e = l[b];
                d.e(e, "Object") || d.e(e, "Array") ? a(e) : l[b] = String(e)
            }
        }

        var k = mt.url, d = mt.lang, f = mt.o, e = mt.i, m = h.s, n = h.A, p = h.fb, v = h.load, g = {
            ...
            init: function () {
                ...
                if (g.hasOwnProperty(b) &&
                    d.e(g[b], "Function")) g[b](a)
            }, _setAccount: function (a) {
                1 < a.length && /^[0-9a-f]{32}$/.test(a[1]) && (g.h |= 1)
            }, _setAutoPageview: function (a) {
                if (1 < a.length && (a = a[1], x === a || u === a)) g.h |= 2, h.b.Ea = a
                ...
                if (1 < a.length && a[1].charAt && "/" === a[1].charAt(0)) {
                    ...
                    h.b.c.vl = e.O() + e.H();
                    h.b.c.kb = 0;
                    h.b.ka ? (h.b.c.nv = 0, h.b.c.st = 4) : h.b.ka = u;
                ...
                2 < a.length && (g.h |= 8, h.b.c.nv = 0, h.b.c.st = 4, h.b.c.et = 4, h.b.c.ep = d.g(a[1]) + "*" + d.g(a[2]) + (a[3] ? "*" + d.g(a[3]) : "") + (a[4] ? "*" + d.g(a[4]) : ""), h.b.j())
                ...
                if (!(3 > a.length)) {
                    ...
                    a = d.g(a[2]);
                    if (e !== t && a !== t) {
                        var f = g.z.page, f = b(f, e, 3, a);
                        g.z.page = f
                    }
                }
            }, _setReferrerOverride: function (a) {
                1 < a.length && (h.b.c.su = a[1].charAt && "/" === a[1].charAt(0) ? m.protocol + "//" + window.location.host + a[1] : a[1], g.Ha = u)
            }, _trackOrder: function (b) {
                b = b[1];
                d.e(b, "Object") && (a(b), g.h |= 16, h.b.c.nv = 0, h.b.c.st = 4, h.b.c.et = 94, h.b.c.ep = f.stringify(b), h.b.j())
                ...
                if (d.e(b, "Object")) {
                    ...
                    if (900 >= k) e.call(this, b); else for (var k = Math.ceil(k / 900), q = "block|" + Math.round(Math.random() * m.K).toString(16) + "|" + k + "|", y = [], z = 0; z < k; z++) y.push(z), y.push(b.substring(900 * z, 900 * z + 900)), e.call(this, q + y.join("|")), y = []
                }
                ...
                if (1 < a.length && (a = a[1], x === a || u === a)) h.b.Fa = a
            }, _setAutoEventTracking: function (a) {
                if (1 < a.length && (a = a[1], x === a || u === a)) h.b.P = a
            }, _trackPageDuration: function (a) {
                1 < a.length ? (a = a[1], 2 === String(a).split(",").length && (h.b.c.et = 3, h.b.c.ep = a, h.b.j())) : n.G("duration-send");
                n.G("duration-done")
            }, _require: function (a) {
                1 < a.length && (a = a[1], m.Wa.test(k.N(a)) && v(a))
            }, _providePlugin: function (a) {
                if (1 < a.length) {
                    var b = window._hmt, e = a[1];
                    a = a[2];
                    if (d.I(m.Ja, e) && d.e(a, "Function") &&
                        (b.plugins = b.plugins || {}, b.D = b.D || {}, b.plugins[e] = a, b.w = b.w || [], a = b.w.slice(), e && a.length && a[0][1] === e)) for (var q = 0, f = a.length; q < f; q++) {
                        var g = a[q][2] || {};
                ...
                if (1 < a.length) {
                    ...
                    if (d.I(m.Ja, e)) if (b.plugins = b.plugins || {}, b.D = b.D || {}, b.plugins[e] && !b.D[e]) b.D[e] = new b.plugins[e](q); else {
                        b.w = b.w || [];
                ...
                if (1 < a.length) {
                    ...
                    if (d.e(a, "Object")) {
                        var e = [], q;
                        for (q in a) a.hasOwnProperty(q) && (e.push(d.g(q)), e.push(d.g(a[q])));
                        e = "*" + e.join("*")
                    }
                    h.b.c.et = 7;
    ...
    (function () {
        function b() {
            "undefined" === typeof window["_bdhm_loaded_" + c.id] && (window["_bdhm_loaded_" + c.id] = u, this.c = {}, this.Fa = this.Ea = u, this.P = l.P, this.xa = f.ma() && 0 < c.aet.length ? c.aet.split(",") : "", this.ka = x, this.init())
        }

        var a = mt.url, k = mt.Na, d = mt.ra, f = mt.lang, e = mt.cookie, m = mt.i, n = mt.localStorage,
            p = mt.sessionStorage, v = mt.o, g = mt.event, l = h.s, r = h.load, s = h.A;
        b.prototype = {
            na: function (a, b) {
                a = "." + a.replace(/:\d+/, "");
                b = "." + b.replace(/:\d+/, "");
                ...
                for (var d = 0; d < c.dm.length; d++) if (-1 < c.dm[d].indexOf("/")) {
                    if (this.Ia(b, c.dm[d])) return u
                } else {
                    var e = a.N(b);
                    if (e && this.na(e, c.dm[d])) return u
                }
                return x
            }, T: function () {
                ...
                var b = x;
                this.V(document.referrer) && this.V(document.location.href) ? b = u : (b = a.N(document.referrer), b = this.na(b || "", document.location.hostname));
                return b ? l.F - l.J > c.vdur ? 1 : 4 : 3
            }, getData: function (a) {
                try {
                    return e.get(a) || p.get(a) || n.get(a)
                } catch (b) {
                }
            }, setData: function (a, b, d) {
                try {
                    e.set(a, b, {domain: this.T(), path: this.ga(), M: d}), d ? n.set(a, b, d) : p.set(a, b)
                } catch (f) {
                }
            }, Sb: function (a) {
                try {
                ...
                this.Ea ? (this.ka = u, this.c.et = 0, this.c.ep = "", this.c.vl = m.O() + m.H(), this.j(a)) : a();
                this.C = +new Date
            }, j: function (a) {
                if (this.Fa) {
                    var b = this;
                ...
                var b;
                try {
                    b = v.parse(p.get("Hm_unsent_" + c.id) || "[]")
                } catch (d) {
                    b = []
                }
                var e =
                ...
                p.set("Hm_unsent_" + c.id, v.stringify(b))
            }, Ka: function (a) {
                var b;
                try {
                    b = v.parse(p.get("Hm_unsent_" + c.id) || "[]")
                ...
                if (b.length) {
                    ...
                    b.length ? p.set("Hm_unsent_" + c.id, v.stringify(b)) : this.za()
                }
            }, za: function () {
    ...
    (function () {
        var b = mt.i, a = mt.lang, k = mt.event, d = mt.o;
        if ("undefined" !== typeof h.b && (c.med || (!b.la || 7 < b.Hb) && c.cvcc)) {
            var f, e, m, n, p = function (a) {
                if (a.item) {
                ...
                h.b.c.et = 86;
                h.b.c.ep = d.stringify(g);
                h.b.j();
                for (g = +new Date; 400 >= +new Date - g;) ;
            };
            if (c.med) e = "/zoosnet", f = "swt", m = /swt|zixun|call|chat|zoos|business|talk|kefu|openkf|online|\/LR\/Chatpre\.aspx/i, n = {
                click: function () {
            ...
            if ("undefined" !== typeof n && "undefined" !== typeof m) {
                ...
                e += /\/$/.test(e) ? "" : "/";
                var s = function (b, d) {
                    if (r === d) return g(e + b, d), x;
                    if (a.e(d, "Array") || a.e(d, "NodeList")) for (var f = 0, k = d.length; f < k; f++) if (r === d[f]) return g(e + b + "/" + (f + 1), d[f]), x
                };
                k.d(document, "mousedown", function (b) {
                    b = b || window.event;
                    r = b.target || b.srcElement;
                    var d = {};
                    for (v(n, function (b, e) {
                        d[b] = a.e(e, "Function") ? e() : document.getElementById(e)
                    }); r &&
                         r !== document && v(d, s) !== x;) r = r.parentNode
                })
            }
        }
    })();
    (function () {
        var b = mt.f, a = mt.lang, k = mt.event, d = mt.o;
        if ("undefined" !== typeof h.b && a.e(c.cvcf, "Array") && 0 < c.cvcf.length) {
            var f = {
                Sa: function () {
                    for (var a = c.cvcf.length, d, n = 0; n < a; n++) (d = b.Aa(decodeURIComponent(c.cvcf[n]))) && k.d(d, "click", f.fa())
                }, fa: function () {
                    return function () {
                        h.b.c.et = 86;
                        var a = {n: "form", t: "clk"};
    ...
    (function () {
        ...
        if (c.med && "undefined" !== typeof h.b) {
            var k = +new Date, d = {n: "anti", sb: 0, kb: 0, clk: 0}, f = function () {
                h.b.c.et = 86;
                h.b.c.ep = a.stringify(d);
                h.b.j()
            };
